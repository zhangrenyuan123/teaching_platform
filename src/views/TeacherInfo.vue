    ...
    <div class="teacherInfo">
        ...
        <div class="right_content">
            <div class="right_container">
                <p><span>教师号： </span>{{info.num}}</p>
                <p><span>姓名： </span>{{info.name}}</p>
                <p><span>性别： </span>{{info.sex}}</p>
                <p><span>职位 ： </span>{{info.level}}</p>
        ...
        <el-dialog title="教师信息" :visible.sync="dialogFormVisible">
            <el-form :model="info" :rules="infoFormRules" ref="infoFromRef">
                <el-form-item label="教师号" label-width="120px">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="updateTeacherInfo">确 定</el-button>
            </div>
        </el-dialog>
...
export default {
    ...
    methods: {
        ...
        async getTeacherInfo(){
            ...
            this.info.num = result[0].Teacher_num;
            this.info.name = result[0].Teacher_name;
            this.info.sex = result[0].Teacher_sex;
            this.info.tel = result[0].Teacher_tel;
            this.info.email = result[0].Teacher_email;
            this.info.qq = result[0].Teacher_qq;
            this.info.level = result[0].Teacher_level;
        ...
        updateTeacherInfo(){
            ...
            this.$refs.infoFromRef.validate(async valid => {
                if(!valid) return;
                let {data : result} = await this.$http.post('/updateTeacherInfo',this.info);
